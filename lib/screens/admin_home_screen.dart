...
import 'package:sports_store/widgets/admin_product_item.dart';
...
class _AdminHomeScreenState extends State<AdminHomeScreen> {
  ...
  void _searchProducts(String query) {
    List<Product> searchResults = products.where((product) => product.name.toLowerCase()
        ...
        return AlertDialog(
          ...
          actions: [
            ElevatedButton(
              onPressed: () {
                if (_validateFields()) {
                  addProduct(nameController.text, imageUrlController.text, priceController.text,
                    descriptionController.text,);
  ...
  bool _validateFields() {
    if (nameController.text.isEmpty || imageUrlController.text.isEmpty || priceController.text.isEmpty ||
