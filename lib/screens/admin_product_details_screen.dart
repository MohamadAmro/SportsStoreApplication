...
import 'package:sports_store/models/product.dart';
...
class _AdminProductDetailsScreenState extends State<AdminProductDetailsScreen> {
  ...
  bool _validateUpdateFields() {
    if (selectedProductIdController.text.isEmpty || updateNameController.text.isEmpty ||
        updateImageUrlController.text.isEmpty || updatePriceController.text.isEmpty ||
  ...
  void _performUpdate() {
    updateProduct(selectedProductIdController.text, updateNameController.text,
      updateImageUrlController.text, updatePriceController.text, updateDescriptionController.text,);
